...
<div class="container min-h-screen pt-12 pb-20 relative">
    ...
    <div class="mt-16 text-center">
        <a href="home.php" class="btn btn-secondary shadow-sm hover-scale items-center gap-2" style="border-radius: var(--radius-lg); padding: 0.8rem 2rem; display: inline-flex; font-weight: bold;">
